      ...
      >
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                    error && !url.trim() ? 'border-red-300 bg-red-50' : 'border-gray-300'
                  }`}
                />
          ...
          {sentiment && (
            ...
            >
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6">
                ...
                <p className="text-gray-700 leading-relaxed">{sentiment}</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
                  ...
                  items.length > 0 && (
                    <motion.div
                      ...
                      className={`p-6 rounded-2xl ${
                        key === 'strengths' ? 'bg-green-50 border border-green-200' :
                        key === 'weaknesses' ? 'bg-red-50 border border-red-200' :
                        key === 'opportunities' ? 'bg-blue-50 border border-blue-200' :
                        'bg-yellow-50 border border-yellow-200'
                      }`}
                    >
                      <h4 className={`font-semibold mb-4 flex items-center gap-2 ${
                        key === 'strengths' ? 'text-green-800' :
                        key === 'weaknesses' ? 'text-red-800' :
                        key === 'opportunities' ? 'text-blue-800' :
                        'text-yellow-800'
                      }`}>
                        {key === 'strengths' && '💪'}
                        {key === 'weaknesses' && '⚠️'}
        ...
        {!loading && !reviews.length && !error && (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Ready to analyze reviews! 🎯</h3>
            <p className="text-gray-600 max-w-md mx-auto">
              Enter a Google Maps URL above to get started with your comprehensive review analysis.
            </p>
          </motion.div>
        )}
      </motion.div>
